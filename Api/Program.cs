...
builder.Services.AddAuthentication(JwtBearerDefaults.AuthenticationScheme)
    .AddJwtBearer(options =>
    {
        ...
        {
            // validate the token based on the key we have provided inside appsettings.development.jason JWT:Key
...
// Authentication verifies the identity of a user or service, authoriration determines their access rights.
